...
//    private UserRepository userRepository;
    ...
    void findAllByFolderId() {
        ...
        List<QuoteDto.QuoteResponse> content = quotes.getContent();
        ...
        assertThat(content.stream().map(QuoteDto.QuoteResponse::getQuoteId).collect(Collectors.toList()))
        ...
        log.info("QuoteDto.QuoteResponse : {}", quotes.getContent());
    }
    ...
    void findAllByQuoteId() {
        QuoteDto.QuoteResponse quoteResponseDto = quoteRepository.findAllByQuoteId(60L).get();
    ...
    void findAllByQuoteId_데이터가_없는_경우() {
        QuoteDto.QuoteResponse quoteResponseDto = quoteRepository.findAllByQuoteId(Long.MAX_VALUE).get();
        log.info("quoteResponseDto : {}", quoteResponseDto);
    }
}